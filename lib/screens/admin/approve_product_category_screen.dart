...
class ApproveProductCategoryScreen extends StatefulWidget {
  const ApproveProductCategoryScreen({Key key}) : super(key: key);
  static const routeName = 'apporve-product-category-screen';

  @override
  _ApproveProductCategoryScreenState createState() => _ApproveProductCategoryScreenState();
}

class _ApproveProductCategoryScreenState extends State<ApproveProductCategoryScreen> {
                    ...
                    children: [
                      ListTile(
                          ...
                          onTap: ()=>Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ApproveCategoryProductDetailScreen(_categories[i]['categoryname'].toString())))//Navigator.pushNamed((context)=>AddProductScreen(0));//Navigator.of(context).pushNamed(AddProductScreen.routeName,arguments: i),
                      ),
                      Divider()
                    ],
                  ),
